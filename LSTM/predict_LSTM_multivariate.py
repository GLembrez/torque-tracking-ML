...
def initialize_net(trained_weights):
    input_len = 50
    sequence_len = 10
    net = LSTM(num_features=25, input_size=input_len, hidden_size=100, num_layers=2, seq_length=sequence_len)
...
def get_predictions(args):
    ...
    eval_set = TorqueTrackingDataset(input_len, sequence_len,args.dataset, meanstd, is_train=False)
